...
const Signup = () => {
  ...
  const [firstName, setFirstName] = useState("Facility");
  const [lastName, setLastName] = useState("Officer");
  const [email, setEmail] = useState("facility@tzw.test");
  ...
  return (
    <RegistrationLayout>
      ...
      >
        <AuthHeader subtitle="Create a fire safety system account" title="Join TZW Safety" />
        ...
        <div className="space-y-5">
          ...
          <FormButton onClick={() => toast("External signup is disabled for the exam demo")} variant="soft">
            <FcGoogle aria-hidden="true" size={18} /> External signup disabled
          </FormButton>
        </div>
