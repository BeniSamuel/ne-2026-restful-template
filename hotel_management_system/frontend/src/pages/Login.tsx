    ...
    <RegistrationLayout>
      ...
      >
        ...
        <div className="space-y-5">
          ...
          <FormButton onClick={() => toast("Google login is a placeholder for exam templates")} variant="soft">
            <FcGoogle aria-hidden="true" size={18} /> Log in with Google
          </FormButton>
          <button className="w-full text-sm font-semibold text-black/45 hover:text-black" onClick={fillAdminDemo} type="button">
